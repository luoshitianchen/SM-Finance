...
#   ./scripts/restore.sh /backup/sm-finance/20260916_020000.sql.gz
#   ./scripts/restore.sh -f /backup/sm-finance/20260916_020000.sql.gz   # 非交互，跳过确认
#
# 环境变量：
