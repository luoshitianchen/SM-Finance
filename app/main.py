...
VERSION = "1.0.0"
SERVICE_NAME = "sm-finance"
DISPLAY_NAME = "SM Finance"
DESCRIPTION = "财务管理系统：总账、应收应付、报销与报表"
...
class Item(BaseModel):
    ...
    owner: str = Field(default="财务共享部", min_length=1, max_length=80)
    priority: Literal["P0", "P1", "P2", "P3"] = "P1"
    status: Literal["planned", "active", "review", "closed"] = "active"

ITEMS: list[dict[str, object]] = [
    {"id": "demo-1", "name": "核心能力基线", "owner": "财务共享部", "priority": "P1", "status": "active", "created_at": datetime.now(UTC).isoformat()},
